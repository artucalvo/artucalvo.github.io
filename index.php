...
<body id="page-top" class="index">
    ...
    <section id="about">
        <div class="container">
		    ...
		    <p>After two enriching years in academia, I joined <a href="https://www.accenture.com/no-en/" target="_new">Accenture</a>, first in Ireland and later in Norway as a <b>Digital Technology Manager</b>, where I am the lead tech architect and agile champion in large cross-industry projects for world-class clients.</p>
                </div>
                <div class="col-lg-4">
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal8" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-content">
            ...
            <div class="container">
			    ...
			    <p style="text-align: justify;">In addition, I am the <b>Agile Champion</b> for Accenture Norway, being the responsible of training teams on Agile ways of working in the country. Also I represent Accenture as <b>speaker</b> in multiple international conferences in the topics of AI, Ethics and Technology Architecture. Finally, I am the <b>Community Lead</b> for Accenture Digital in the Nordics, organising tech meetups accross Scandinavia.</p>
                            <ul class="list-inline item-details">
                                <li>Role:
