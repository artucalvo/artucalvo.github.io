...
<head>
    ...
    <title>Arturo Calvo - Responsible AI Lead | Agile Champion | Tech Manager | AI Artist</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Arturo Calvo</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills">Responsible AI Lead | Agile Champion | Tech Manager | AI Artist</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>I am a technology enthusiast with over 15 years of experience working in startups, corporations and academia in 5 different countries.</p> <p>Early in my career I worked as a <b>Software Engineer</b> and <b>IT Business Analyst</b> in Ireland and Spain.</p> <p>Between 2012-2014 I founded three startups: <i>Greenweaving</i> (web app to generate interactive diagrams on the fly), <i>iFlikeU</I> (Tinder for Facebook friends) and <i>Dialective</i> (web app to generate interactive catalogs for retailers). As an <b>entrepreneur</b> I raised hundreds of thousands of USD in funding and I won multiple awards around Europe.</p> <p>In 2014 I started working as a <b>Senior Research Software Architect</b> at <a href="http://www.adaptcentre.ie" target="_new">ADAPT Centre</a>, a world-class innovation hub based in Trinity College Dublin, where I led the development of research projects in the areas of <b>Machine Learning</b>, <b>SaaS</b> and <b>Ethics</b>.</p>
		    <p>After two enriching years in academia, I joined <a href="https://www.accenture.com/no-en/" target="_new">Accenture</a>, first in Ireland and later in Norway as a <b>Digital Technology Manager</b>, where I am the lead tech architect in large cross-industry projects for world-class clients. In addition, I am the Responsible AI Lead and Agile Champion in Accenture Norway.</p>
                </div>
                <div class="col-lg-4">
                    <p>In 2019 I founded <a href="https://aimade.art" target="_new">AImade.art</a>, an online store that sells unique artworks generated by Artificial Intelligence.</p>
                    <p>For 2.5 years I held a part-time <b>CTO</b> position in <a href="https://www.sedicii.com" target="_new">Sedicii</a>, a World Economic Forum awarded startup that provides identity verification services. In the past I also founded <i>XchangeUp</i> (P2P currency exchange platform), <a href="https://www.ethicscanvas.org" target="_new">Ethics Canvas</a> (collaborative tool to brainstorm about ethical impacts of digital projects), <i>Xtegos</i> (funny voice generator app), the <a href="http://www.srsireland.org" target="_new">Spanish Research Society in Ireland</a>, <a href="http://www.spanskkultur.no" target="_new">Spansk Kultur</a>, <a href="https://www.meetup.com/Machine-Learning-Dublin/" target="_new">Machine Learning Dublin</a> and <a href="https://www.meetup.com/Digital-Innovators-Oslo/" target="_new">Digital Innovators Oslo</a>. <p>Passionate about technology and entrepreneurship, I have been <b>keynote speaker</b> in multiple events worldwide, I am a <b>seed investor</b> in startups, and a <b>lecturer</b> in different innovation programs.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal11" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/aimadeart.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                ...
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="https://www.twitter.com/artucalvo" target="_new" class="btn-social btn-outline"><i class="fa fa-fw fa-twitter"></i></a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>AImade.art</h2>
                            <hr class="star-primary">
                            <p style="text-align: justify;">In 2019 I founded <a href="https://aimade.art" target="_new">AImade.art</a>, an online store that sells unique pieces of art generated by Artificial Intelligence, printed in canvas and shipped anywhere in the world. Limited edition: only one copy per design will ever be sold.
                            <p style="text-align: justify;">The algorithm is using Generative Adversarial Networks (GANs) that, trained during several weeks over +20k public domain oil paintings, it is able to generate from scratch new portrait, landscape and abstract artworks.</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Accenture</h2>
                            <hr class="star-primary">
                            <p style="text-align: justify;">I started my career in Accenture at <a href="https://www.accenture.com/us-en/company-dublin-innovation-centre-the-dock" target="_new">The Dock</a>, our global innovation hub for emerging technologies, I was leading the development of large cross-industry projects that apply cutting-edge research on <b>Artificial Intelligence</b> to different verticals.
                            <p style="text-align: justify;">In August 2017 I transferred to <b><a href="https://www.accenture.com/no-en/" target="_new">Accenture Norway</a></b>, where I hold a <b>Digital Business Integration Manager</b> position, leading the architecting and development of innovative solutions to complex problems for world-class clients, using technologies such as Machine Learning, Web/Mobile Engineering, IoT or XR. I am a certified <b>Technology Architect</b>, <b>Data Architect</b> and <b>SAFe Practicioner</b>.</p>
			    <p style="text-align: justify;">In addition, I am the <b>Responsible AI Lead</b> and <b>Agile Champion</b> in Accenture Norway, being the responsible of training and client projects on AI Ethics and Agile Ways of Working in the country. Also I represent Accenture as <b>speaker</b> in multiple international conferences in the topics of AI, Ethics and Technology Architecture. Finally, I am the <b>Community Lead</b> for Accenture Digital in the Nordics, organising tech meetups accross Scandinavia.</p>
                            <ul class="list-inline item-details">
                                <li>Role:
                                    <strong>Digital Technology Manager</strong>
                                </li>
                                <li>Dates:
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <p style="text-align: justify;"><b><a href="https://www.sedicii.com" target="_new">Sedicii</a></b> is a a multi-award winning startup that provides <b>identity verification</b> services, eliminating the need to transmit sensitive data over the network using our patented <a href="https://en.wikipedia.org/wiki/Zero-knowledge_proof" target="_new">Zero-Knowledge Proof</a> technology. In 2015 we were selected by the World Economic Forum as a <b><a href="http://widgets.weforum.org/techpioneers-2015b/" target="_new">Technology Pioneer</a></b>, recognizing Sedicii as a technology with the potential to change the world.</p>
                            <p style="text-align: justify;">As <b>CTO</b> I was leading the development of our identity verification <b>SDK</b> and integrating it in our partners' solutions with the highest standards of security, reliability and performance.</p>
                            <ul class="list-inline item-details">
                                <li>Role:
                                    <strong>CTO</strong>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>ADAPT Centre</h2>
                            <hr class="star-primary">
                            <p style="text-align: justify;"><b><a href="http://www.adaptcentre.ie" target="_new">ADAPT</a></b> is a dynamic research center that combines the world-class expertise of 120+ researchers at four top Irish universities with that of its industry partners to produce ground-breaking digital content innovations.</p>
                            <p style="text-align: justify;">My role as a <b>Senior Research Software Architect</b> based at Trinity College Dublin was to lead the development of research projects in the areas of <b>machine learning</b>, <b><a href="https://xchange.adaptcentre.ie" target="_new">team collaboration</a></b> and <b><a href="https://www.ethicscanvas.org" target="_new">ethics</a></b>.</p>
                            <p style="text-align: justify;">I was responsible of implementing the <b>Scrum</b> framework in my team, along with <b>software engineering</b> best practices (clean code, TDD and continuous integration). In addition, I was frequently invited to <b>lecture</b> in the <a href="https://sites.google.com/site/cs3bc21516s2/home" target="_new">e-Business II</a> and <a href="https://sites.google.com/site/cs70091516s2/home" target="_new">Networked Applications I</a> courses in Trinity College Dublin.</p>
							<p style="text-align: justify;">Finally, I co-organised and presented the <a href="https://www.meetup.com/Machine-Learning-Dublin/" target="_new">Machine Learning Dublin</a></b>, a monthly meetup that grew from 0 to 1400 members in 10 months; and I was <b>tutor</b> at the <a href="http://adaptcentre.ie/ailo/" target="_new">All-Ireland Linguistics Olympiads</a>.</p>
                            <ul class="list-inline item-details">
                                <li>Role:
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <p style="text-align: justify;">As <b>CTO</b> of Dialective Ltd I was coordinating the <b>Product Management</b> and <b>Development</b> of five different products:</p>
                            <ul>
                              <li class="bullets"><b><a href="http://www.dialective.com" target="_new">Dialective:</a></b> web tool to create online catalogs to promote and sell products or services.</li>
                              <li class="bullets"><b>Rebajapp:</b> app to get discounts in SMEs in exchange for Facebook likes and posts.</li>
                              <li class="bullets"><b>Copromly:</b> web app that uses co-promotion in order to get increase your blog audience.</li>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>iFlikeU Inc.</h2>
                            <hr class="star-primary">
                            <p style="text-align: justify;"><b>iFlikeU</b> was an Android and Facebook app that let you find matches among your Facebook friends while keeping your identity safe. Using PHP and Phonegap technologies, iFlikeU included other features such as an anonymous messenger and a match-maker tool. It was featured in tech blogs such as <a href="http://geeksroom.com/2013/03/con-iflikeu-puedes-descubrir-atracciones-mutuas-con-amigos-de-facebook/73251/" target="_new">Geeksroom</a> and <a href="http://wwwhatsnew.com/2013/03/26/iflikeu-conectando-a-amigos-que-se-gustan-mutuamente/" target="_new">wwwhatsnew</a>.</p>
                            <p style="text-align: justify;">My role as <b>CEO</b> of the company was validating the value proposition following the <b>Lean Startup</b> principles and helping in the development of the <b>minimum-viable-product</b>.</p>
                            <ul class="list-inline item-details">
                                <li>Role:
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <p style="text-align: justify;">I helped the <b><a href="http://www.basketcyl.com" target="_target">FBCyL</a></b> become one of the leading Spanish sport federations in terms of technology by architecting a <b>Web 2.0. platform</b> that provided different services online. This platform had a huge impact in reducing the administrative costs and improving the media coverage.</p><br>
