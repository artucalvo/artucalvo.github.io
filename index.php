    ...
    <section id="about">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <p>I combine this role with the <b>CTO</b> position in <a href="https://www.sedicii.com" target="_new">Sedicii</a>, a multi-award winning startup that provides disruptive user authentication services to large corporations.</p> <p>Passionate about technology and entrepreneurship, I am <b>advisor</b> of multiple startups and <b>mentor</b> in accelerators and innovation programs such as the prestigious <a href="https://www.imagine.cc" target="_new">Imagine Creativity Center</a>.</p> <p>In addition, I am the organizer of three popular <b>meetup groups</b> on Machine Learning, Research and Entrepreneurship in Ireland and Spain.</p> <p>Finally, I enjoy experimenting with new technologies and launching <b>side projects</b>, such as <a href="http://www.xtegos.com" target="_new">Xtegos</a> (speech synthesis with funny accents).</p> <p>My goal is to keep working on cutting-edge projects where I can have a clear <b>positive impact</b>, in an inspiring environment anywhere in the world. <a href="#contact">Ping me</a> if you want to have a chat!</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
			    			...
			    			<p style="text-align: justify;">I have implemented the <b>Scrum framework</b> in the organization, along with <b>software engineering best practices</b> (clean code, TDD and continuous integration). In addition, I am <b>Assistant Lecturer</b> in the e-Business II and Network Applications I courses in the School of Computer Science and Statistics, and I am tutor at the <a href="http://adaptcentre.ie/ailo/" target="_new">All-Ireland Linguistics Olympiads</a>.</p>
