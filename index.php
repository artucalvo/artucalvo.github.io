                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <p style="text-align: justify;"><b><a href="https://www.sedicii.com" target="_new">Sedicii</a></b> is a a multi-award winning startup that provides <b>identity verification</b> services, eliminating the need to transmit sensitive data over the network using our patented <a href="https://en.wikipedia.org/wiki/Zero-knowledge_proof" target="_new">Zero-Knowledge Proof technology</a>. In 2015 we were selected by the World Economic Forum as a <b><a href="http://widgets.weforum.org/techpioneers-2015b/" target="_new">Technology Pioneer</a></b>, recognizing Sedicii as a technology with the potential to change the world.</p>
                            <p style="text-align: justify;">As <b>CTO</b> I am leading the development of our identity verification SDK and integrating it in our partners' solutions with the highest standards of security, reliability and performance.</p>
                            <ul class="list-inline item-details">
                                <li>Role:
                                    <strong>CTO</strong>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p style="text-align: justify;">My role as a <b>Senior Research Software Architect</b> based at Trinity College Dublin was to lead the development of research projects in the areas of <b>machine learning</b>, <b>team collaboration</b> and <b>ethics</b>.</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <ul>
                              <li><b><a href="http://www.dialective.com" target="_new">Dialective:</b> web tool to create online catalogs to promote and sell products or services.</li>
                              <li><b>Rebajapp:</b> app to get discounts in SMEs in exchange for Facebook likes and posts.</li>
                              <li><b>Copromly:</b> web app that uses co-promotion in order to get increase your blog audience.</li>
                              <li><b>Greenweaving:</b> web service to contact potential customers via Linkedin inMails.</li>
                              <li><b>Obfuscriptor:</b> web app to obfuscate and compress Javascript code.</li>
							</ul>
							<p style="text-align: justify;">Dialective was presented in 7 countries, and won some <b>international awards</b>. We were selected to participate in <a href="http://siliconvalley.imagine.cc/2013/participants/" target="_new">Imagine Creativity Center (Silicon Valley) and <a href="www.oxygenaccelerator.com/startup/dialective/" target="_new">Oxygen Accelerator (London).</p>
